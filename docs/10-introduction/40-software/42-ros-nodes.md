...
slug: ros-nodes
title: "ROS2 ноды"
sidebar_label: "ROS2 ноды"
sidebar_position: 2
description: "Описание запущенных на ровере ROS2 узлов"
---
...
Нода `/imu` работает с инерциальным модулем. Она получает данные об ускорениях, угловых скоростях и ориентации и публикует их в систему ROS.
