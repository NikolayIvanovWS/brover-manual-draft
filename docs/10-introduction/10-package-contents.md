...
В базовый комплект **BRover-E5** входит полностью готовая к работе робототехническая платформа, а также необходимое оборудование для питания и начального запуска.

## Состав комплекта

Основой набора является собранный ровер, включающий все ключевые электронные и механические компоненты, а также внешние элементы питания и обслуживания.
...
| Аккумуляторная сборка | <figure style={{textAlign: 'center'}}><img src={require("./img/tb-battery.png").default} alt="qj" width="200" /></figure> |
| Блок питания | <figure style={{textAlign: 'center'}}><img src={require("./img/power-on.jpg").default} alt="qj" width="200" /></figure> |
| Зарядное устройство | <figure style={{textAlign: 'center'}}><img src={require("./img/skyrc-s65.jpg").default} alt="qj" width="200" /></figure> |

## Опциональные компоненты

Некоторые элементы могут поставляться отдельно и предназначены для расширения возможностей управления ровером.

| Наименование | Изображение |
|--------------|------------|
| Адаптер для подключения радиомодельных пультов <br /> [(SBus → USB)](https://vbcores.ru/products/sbus-hid) | <figure style={{textAlign: 'center'}}><img src={require("./img/vb-sbus-hid-v1_1-1.jpg").default} alt="qj" width="200" /></figure> |
| Джойстик RadioLink T8S | <figure style={{textAlign: 'center'}}><img src={require("./img/RadioLink-T8S.png").default} alt="qj" width="200" /></figure> |

Наличие опциональных компонентов зависит от комплектации поставки.